...
"""Verify that starting gandercoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gandercoin with -h for help text")
        ...
        self.log.info("Start gandercoin with -version for version information")
        ...
        self.log.info("Start gandercoind with -fakearg to make sure it does not start")
