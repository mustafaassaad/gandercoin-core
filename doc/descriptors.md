# Support for Output Descriptors in Gandercoin Core

Since Gandercoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Gandercoin Core wallets, a convenience function `combo` is
