Gandercoin Core version *0.15.1* is now available from:

  <https://download.gandercoin.org/gandercoin-0.15.1/>
...
A number of changes to the way Gandercoin Core deals with peer connections and invalid blocks
