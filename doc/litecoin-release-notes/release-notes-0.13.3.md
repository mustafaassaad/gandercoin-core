Gandercoin Core version 0.13.3 is now available from:

  <https://download.gandercoin.org/gandercoin-0.13.3/>
...
updates will be released anymore. Without security updates, using a gandercoin
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/gandercoin-project/gandercoin/blob/0.13/src/chainparams.cpp#L214).
