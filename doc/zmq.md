...
The ZeroMQ feature in Gandercoin Core requires the ZeroMQ API >= 4.0.0
...
during the *configure* step of building gandercoind:
...
For instance:
    ...
    $ gandercoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubrawtx=ipc:///tmp/gandercoind.tx.raw \
...
From the perspective of gandercoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into gandercoind directly. Furthermore, no information is
...
using. Gandercoind appends an up-counting sequence number to each
