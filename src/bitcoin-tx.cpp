...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " gandercoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  gandercoin-tx [options] <hex-tx> [commands]  Update hex-encoded gandercoin transaction\n" +
            "or:     gandercoin-tx [options] -create [commands]   Create hex-encoded gandercoin transaction\n" +
            "\n";
