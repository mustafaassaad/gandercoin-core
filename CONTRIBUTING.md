Contributing to Gandercoin Core
============================

The Gandercoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Gandercoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/gandercoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to gandercoin-qt
...
The following applies to code changes to the Gandercoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Gandercoin
Network Protocol consensus changes.

Whether a pull request is merged into Gandercoin Core rests with the project merge
...
Patches that change Gandercoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gandercoin consensus, it must have been
...
The project leader is the release manager for each Gandercoin Core release.
